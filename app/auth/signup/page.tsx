...
import { Github, Users, Search } from "lucide-react"
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-2">Join Roster</h1>
        ...
        <Card className="border-border bg-card">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Choose how you want to join the marketplace</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {/* User Type Selection */}
            <div className="space-y-3">
              <Label className="text-sm font-medium">I want to:</Label>
              <RadioGroup defaultValue="talent" className="grid grid-cols-1 gap-4">
                <div className="flex items-center space-x-3 rounded-lg border border-border p-4 hover:bg-muted/50 transition-colors">
                  ...
                  <div className="flex items-center space-x-3 flex-1">
                    ...
                    <div>
                      <Label htmlFor="talent" className="font-medium cursor-pointer">
                        Showcase my skills
                      </Label>
                      <p className="text-xs text-muted-foreground">I'm a tech professional looking for opportunities</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center space-x-3 rounded-lg border border-border p-4 hover:bg-muted/50 transition-colors">
                  ...
                  <div className="flex items-center space-x-3 flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">I'm hiring and want to discover great people</p>
                    </div>
                  </div>
                </div>
              </RadioGroup>
